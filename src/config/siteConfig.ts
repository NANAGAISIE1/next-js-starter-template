...
export const siteConfig = {
  ...
  description:
    "Smartnote: Your Intelligent Learning and Note-Taking Platform! Centralize your course materials, take smart notes, and enhance your learning experience. SmartNote Hub is your dedicated space for organized learning, AI-powered quizzes, and efficient timetable management. Elevate your education with seamless organization and personalized learning paths. Get ready to turn your notes into knowledge with SmartNote Hub – Where Every Note Sparks Intelligence!",
  image: {
